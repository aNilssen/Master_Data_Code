...
2. **Data Loading & Initial Setup**
   ...
   * **Excel/CSV Reads**:
     ...
     N = pd.read_excel('distance_matrix.xlsx')['port_id'].to_list()
...
7. **Loading & Unloading Rates**
   ...
   * Hard‐coded dictionaries:
     ...
     ```python
     load_tpd = {
         100199: 22572, 250100: 22572, ..., 270900: 63216, 271000: 63216
     }
     unload_tpd = {
         100199: 17000, 250100: 17000, ..., 270900: 51840, 271000: 51840
     }
     ```
...
4. **Adjust Scenario Settings**
   ...
   * In the final cell, call:
     ...
     ```python
     scenario_kpi, fleet_df = run_scenario(
         demand_df = data,        # or a filtered subset of 'data'
         scenario_id = "BaseCase",
         compliance   = compliance_dict,
         home_port    = 0,
         fuel_price   = 550,      # can override default 1000
